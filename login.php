    ...
    <div class="login-form">
        <div class="main-div">
            ...
            <form method="post" action="">
                <br><br><br><br>
                <br>
                <div class="container" style="width: 70%; margin: auto; margin-left: 100px; width:450px; background-color:#D7A86E; opacity:80%;border-radius:5%; float:left; padding:30px">
                    <br>
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color:#A64B2A; width: 80%; margin-left: 10%; margin-top:5%; border: 1px #80da62;font-size:20px; font-weight:bold" 
