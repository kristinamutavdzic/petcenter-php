        ...
        <div class="container">
            <div class="row" >
                <div class="col-lg-8 col-lg-offset-2 centered" style="display:flex; justify-content:flex-start; align-items: center; width: 90%">
                    ...
                    <h2 style="color:white ; background-color:#A64B2A; padding:50px; border-radius:50%; margin-top:10px; width: 49%"> Dobrodosli u Pet Center. Pronađite najbolje proizvode za vaše ljubimce!</h2>
